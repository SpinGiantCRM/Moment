...
Database path: ``~/.config/clip-tray/clips.db``
"""
...
from clip_tray.utils.system import sanitize_stem
...
DB_DIR = os.path.expanduser("~/.config/clip-tray")
DB_PATH = os.path.join(DB_DIR, "clips.db")
OLD_JSON_PATH = os.path.join(DB_DIR, "clips.json")
OLD_JSON_BAK = os.path.join(DB_DIR, "clips.json.bak")
