...
class GridPage(QWidget):
    ...
    def __init__(self, store: "Store | None" = None, parent=None) -> None:
        ...
        # Delegate
        from clip_tray.ui.widgets.clip_delegate import ClipDelegate
    ...
    def _build_empty_state(self) -> QWidget:
        ...
        shortcuts_btn.clicked.connect(lambda: logger.info("Shortcuts — not yet implemented"))
        btn_layout.addWidget(shortcuts_btn)
        capture_btn = QPushButton("Capture Settings")
        capture_btn.clicked.connect(lambda: logger.info("Capture settings — not yet implemented"))
    ...
    def _build_error_state(self) -> QWidget:
        ...
        reset_btn.clicked.connect(lambda: logger.info("Reset DB — not yet implemented"))
        btn_layout.addWidget(reset_btn)
        config_btn = QPushButton("Open Config Folder")
        config_btn.clicked.connect(lambda: logger.info("Open config — not yet implemented"))
