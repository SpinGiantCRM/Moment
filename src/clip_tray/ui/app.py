...
Wires together the tray icon, store, pipeline, and main window.
...
from clip_tray import __version__
from clip_tray.ui.resources import app_font, load_icon, stylesheet
from clip_tray.ui.tray import TrayIcon
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    """Parse CLI arguments for clip-tray.
...
def _global_excepthook(exc_type, exc_value, exc_tb) -> None:
    ...
    try:
        ...
        msg.setWindowTitle("clip-tray — Error")
...
class AppManager(QObject):
    ...
    def init(self) -> None:
        ...
        self._qapp.setApplicationName("clip-tray")
        self._qapp.setOrganizationName("clip-tray")
        ...
        logger.info("clip-tray v%s ready (PID %d)", __version__, os.getpid())
    ...
    def _on_settings(self) -> None:
        ...
        try:
            from clip_tray.ui.dialogs.settings_dialog import SettingsDialog
